              ...
              <li class="nav-item">
                <a href="./index3.html" class="nav-link">
                  ...
                  <p>Dashboard v3</p>
                        ...
                        <li class="nav-item">
                            <a href="buildings.php" class="nav-link active">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <section class="col-lg-8 connectedSortable">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h5 class="card-title">School Buildings</h5>
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <div class="input-group mt-4">
                                                    ...
                                                    <input class="form-control" type="text" name="" placeholder="Enter Name Here" aria-label="School Name">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row mt-4">
                        ...
                        <section class="col-lg-4 connectedSortable">
                            <div class="card h-100">
                                <div class="card-body">
                                    <h5 class="card-title">School: <span class="text-bold">Dawha</span></h5>
